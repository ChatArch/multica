...
func main() {
	...
	registerNotificationListeners(bus, pool, queries)
	...
	go runAutopilotFailureMonitor(autopilotCtx, inboxv2.NewWriter(pool, queries), queries, bus, envFailureMonitorConfig())
