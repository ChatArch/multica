      ...
      entries: [
        {
          version: "0.4.18",
          date: "2026-08-04",
          title: "멈춘 대화를 이어서 말합니다",
          changes: [],
          features: [
            "담당 지정 확인 창을 전송 단축키로 마무리할 수 있어, 마우스가 필요 없습니다.",
            "에이전트를 설계한 대화가 그대로 남아, 나중에 다시 읽어 볼 수 있습니다.",
          ],
          improvements: [
            "에이전트 만들기 화면을 열어 둬도 워크스페이스 전체가 느려지지 않습니다.",
            "에이전트를 만들며 적은 내용이 저장돼, 탭을 옮겨도 사라지지 않습니다.",
            "스킬 파일 행 메뉴에서 바로 편집을 열 수 있습니다.",
            "채팅 추천이 지금 쓰고 있는 언어로 돌아옵니다.",
            "에이전트가 매번 읽는 안내가 짧아져, 그만큼을 실제 작업에 씁니다.",
            "로컬 빌드 런타임은 그렇게 표시되고, 없는 업데이트를 권하지 않습니다.",
            "런타임 상세 페이지 제목에서 머신 이름이 겹치지 않습니다.",
          ],
          fixes: [
            "답변을 멈추고 다음 메시지를 보내도 에이전트가 대화를 기억합니다.",
            "에이전트 만들기 입력창이 전송 후 비워지고, 이어 쓴 내용도 사라지지 않습니다.",
            "스킬 안의 파일을 클릭하면 열리고, 메뉴만 뜨지 않습니다.",
            "Issue의 구독 해제를 누르면 실제로 해제됩니다.",
            "답글 입력창에서 / 를 입력하면 워크스페이스의 빠른 작업도 보입니다.",
            "차단된 Issue를 다른 상태로 되돌리면 에이전트가 다시 이어서 작업합니다.",
            "Issue 헤더에서 실행 중인 로그를 열어도 바로 닫히지 않습니다.",
            "모바일 채팅이 실시간 업데이트를 놓쳐도 스스로 따라잡습니다.",
            "OpenClaw 답변이 끝나는 대로 도착하고, 작업 자리도 바로 비워집니다.",
            "Slack이나 Feishu에서 /new만 보내도 빈 메시지와 빈 실행이 남지 않습니다.",
            "새로 연결한 채팅 채널도 첨부 파일을 제대로 받습니다.",
            "긴 프로젝트 이름이나 레이블 이름이 칩을 한 줄 가득 늘리지 않습니다.",
            "항목을 비우는 자리가 모든 선택 창에서 첫 줄로 통일됐습니다.",
            "자동 운행 런북이 넓어도 설정 패널이 대화창 밖으로 밀리지 않습니다.",
            "중국어 사이드바의 Discord 링크가 중간에 잘리지 않습니다.",
            "Issue를 스쿼드에 지정해도 뒤에서 오류가 나지 않습니다.",
          ],
        },
        {
          version: "0.4.17",
