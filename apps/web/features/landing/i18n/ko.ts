      ...
      entries: [
        {
          version: "0.4.13",
          date: "2026-07-28",
          title: "사용량 오류 분석, GitHub 저장소 가져오기, 사라지지 않는 초안",
          changes: [],
          features: [
            "이제 사용량 페이지에서 에이전트가 얼마나 왜 실패하는지와 실패가 많은 에이전트를 볼 수 있습니다.",
            "이제 URL을 입력하지 않고 GitHub에서 저장소를 바로 골라 가져올 수 있습니다.",
            "보내지 않은 댓글, 답글, 새 Issue의 본문과 첨부 파일이 이제 그대로 남습니다.",
            "채팅이나 댓글에 아주 긴 텍스트를 붙여넣으면 이제 첨부 파일로 바뀝니다.",
            "이제 하위 Issue 헤더에서 목록을 접어도 어떤 에이전트가 일하는지 보입니다.",
            "이제 에이전트를 만들 때 사고 수준과 Codex 속도를 설정할 수 있습니다.",
            "데스크톱 앱이 멈추면 이제 어디에서 멈췄는지 보고할 수 있습니다.",
          ],
          improvements: [
            "Autopilot 웹훅 링크가 이제 기본적으로 숨겨집니다.",
            "메시지를 보낸 뒤 커서가 이제 기대한 자리에 남습니다.",
            "채팅의 이미지와 동영상이 여러 개 한꺼번에 와도 안정적으로 들어옵니다.",
          ],
          fixes: [
            "이제 긴 Issue에서 에이전트가 더 빨리 이어서 작업하고 비용도 줄어듭니다.",
            "Slack과 Lark에서 에이전트가 이제 과정 설명 없이 결과만 답합니다.",
            "스킬 다운로드가 멈추면 이제 멈춤으로 표시되고 작업이 자동으로 다시 시도됩니다.",
            "Issue를 삭제하면 이제 원래 목록으로 돌아갑니다.",
            "내 컴퓨터의 서비스가 시작된 뒤 에이전트를 더 빨리 쓸 수 있습니다.",
          ],
        },
        {
          version: "0.4.12",
