      ...
      entries: [
        {
          version: "0.4.18",
          date: "2026-08-04",
          title: "中断した会話の続きから話せます",
          changes: [],
          features: [
            "担当の確認ダイアログを送信ショートカットで確定でき、マウスが不要になりました。",
            "エージェントを設計した会話がそのまま残り、後から読み返せます。",
          ],
          improvements: [
            "エージェント作成の画面を開いていても、ワークスペース全体が重くなりません。",
            "エージェント作成中に書いた内容が保存され、タブを移動しても消えません。",
            "スキルのファイル行メニューから、そのまま「編集」を開けます。",
            "チャットの候補が、あなたが書いている言語で返ってきます。",
            "エージェントが毎回読む説明が短くなり、その分をあなたの作業に使えます。",
            "ローカル ビルドのランタイムはそう表示され、存在しない更新を勧めません。",
            "ランタイムの詳細ページのタイトルで、マシン名が重複しなくなりました。",
          ],
          fixes: [
            "返信を止めて次のメッセージを送っても、エージェントは会話を覚えています。",
            "エージェント作成の入力欄が送信後に空になり、続けて書いた内容も消えません。",
            "スキルのファイルをクリックすると開くようになり、メニューだけが出ることはありません。",
            "Issue の「購読解除」を押すと、実際に解除されます。",
            "返信欄で / を入力すると、ワークスペースのクイック アクションも表示されます。",
            "ブロック中の Issue を別のステータスに戻すと、エージェントが再開します。",
            "Issue のヘッダーから実行中のログを開いても、すぐに閉じなくなりました。",
            "モバイル チャットが、リアルタイム更新を取りこぼしても自分で追いつきます。",
            "OpenClaw の返信が書き終わり次第届き、タスクの枠も解放されます。",
            "Slack や Feishu で /new だけを送っても、空のメッセージと空の実行が残りません。",
            "新しく追加したチャット チャネルでも、添付ファイルを正しく受け取れます。",
            "長いプロジェクト名やラベル名が、ピルを一行いっぱいに広げなくなりました。",
            "各項目を空にする操作が、どのピッカーでも一番上の行に揃いました。",
            "オートパイロットのランブックが広くても、設定パネルがダイアログから押し出されません。",
            "中国語のサイドバーの Discord リンクが、途中で切れなくなりました。",
            "Issue をスクワッドに割り当てても、裏側でエラーになりません。",
          ],
        },
        {
          version: "0.4.17",
