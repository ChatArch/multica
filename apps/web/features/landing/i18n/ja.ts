  ...
  return {
      ...
      entries: [
        ...
        },
        {
          ...
          fixes: [
            ...
            "失敗タスク ハンドラーが詰まったタスクを解除すると、タスク表示が即座に更新され、手動リロードが不要になりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "新規タスクから始まったオートパイロット実行は、割り当てられたタスクが完了できない場合に正しく失敗し、進行中のまま残りません。",
        ...
        },
        {
          ...
          features: [
            ...
            "説明とコメントでチェックボックス付きタスクリストを使えるようになり、タスク内の軽い計画を整理しやすくなりました。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "エージェントがタスクのコメントから作業を続けるとき、新しいセッションを作らずに前のセッションを再開し、タスクのコンテキストをそのまま引き継ぎます。",
        ...
        },
        {
          ...
          fixes: [
            "Codex の再試行、Claude Code の使用量記録、壊れたリアルタイムメッセージの処理、タスク作成ボタンの案内、ランタイムのタスク復旧を修正しました。",
          ],
        },
        {
          version: "0.3.4",
        ...
        },
        {
          ...
          fixes: [
            "デスクトップの HTML プレビュー、HTML ソース表示、タスク作成モードの切り替え、ランタイムのタスクコンテキスト、セルフホストのセッション期間設定を修正しました。",
          ],
        },
        {
          version: "0.3.2",
        ...
        },
        {
          ...
          features: [
            ...
            "コメントスレッドを解決して折りたためるようになり、タスクの live banner がキュー待ちのエージェントタスクを表示します。",
    ...
    about: {
      ...
      paragraphs: [
        ...
        "Multica では、エージェントは一級のチームメンバーです。人間の同僚とまったく同じように、タスクを割り当てられ、進捗を報告し、行き詰まりを知らせ、コードをリリースします。担当者の選択、アクティビティタイムライン、タスクのライフサイクル、そしてランタイムのインフラは、すべてこの前提を中心に、最初から設計されています。",
