      ...
      entries: [
        {
          version: "0.4.13",
          date: "2026-07-28",
          title: "使用量のエラー分析、GitHub からのリポジトリ取り込み、消えない下書き",
          changes: [],
          features: [
            "使用量ページで、エージェントの失敗の頻度と原因、失敗の多いエージェントがわかるようになりました。",
            "URL を手入力せず、GitHub から直接リポジトリを選べるようになりました。",
            "送信前のコメント・返信・新規 Issue は、本文も添付ファイルも残るようになりました。",
            "チャットやコメントに非常に長いテキストを貼ると、添付ファイルになります。",
            "サブ Issue のヘッダーで、リストを閉じていても稼働中のエージェントがわかります。",
            "エージェントの作成時に、思考レベルと Codex の速度を設定できるようになりました。",
            "デスクトップアプリが固まったとき、どこで止まったかを報告できるようになりました。",
          ],
          improvements: [
            "Autopilot の Webhook リンクは、既定で隠れるようになりました。",
            "送信後のカーソルが、期待どおりの位置に残るようになりました。",
            "チャットの画像や動画が、まとめて届いても確実に取り込まれます。",
          ],
          fixes: [
            "長い Issue でも、エージェントの再開が速くなり費用も下がりました。",
            "Slack と Lark では、エージェントが途中経過ではなく答えだけを返します。",
            "スキルのダウンロードが止まったとき、そう表示され、タスクは自動で再試行します。",
            "Issue を削除すると、元の一覧に戻るようになりました。",
            "お使いのマシンのサービス起動後、エージェントをより早く使えるようになります。",
          ],
        },
        {
          version: "0.4.12",
