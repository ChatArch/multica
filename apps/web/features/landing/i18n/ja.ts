      ...
      entries: [
        ...
        },
        {
          ...
          improvements: [
            ...
            "エージェント 作業が準備中に止まらなくなり、すぐ始まるか素早く失敗します。",
        ...
        },
        {
          ...
          improvements: [
            "長いエージェント 作業が、短い通信の途切れで失敗しなくなり、再試行して続行します。",
        ...
        },
        {
          ...
          improvements: [
            "失敗したエージェント 作業を再実行しても、すでに進んだ作業を保ったまま続けられます。",
          ...
          fixes: [
            ...
            "長いエージェント 作業が、黙って終わったり、終わる前に完了扱いになったりしなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            "同じマシンで並行して動く複数のエージェント 作業が、互いに干渉しなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "長時間動く エージェント 作業（リサーチ、学習、コード生成）が、ローカル デーモンが生きている限りサーバー側で落とされなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Codex エージェントの作業 ホームからデーモンの Codex モデル カタログが再び見えるようになりました。（コミュニティ報告）",
        ...
        },
        {
          ...
          improvements: [
            ...
            "チャットのライブ タイムラインがストリーミング 作業 メッセージのたびに再マウントされなくなり、長時間のエージェント実行でもレンダーが滑らかに保たれます。",
          ],
          fixes: [
            "同じスクワッド内でサブタスクが完了したとき、親タスクのスクワッド リーダーが起動され、親タスクが in_progress のまま止まりません。",
            "デーモン管理下のエージェント CLI が作業 トークンを失うと即座に失敗し、書き込みがワークスペース オーナー名義になりません。（コミュニティ報告）",
