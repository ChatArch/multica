...
export function createZhDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    headlineLine2: "\u4e0d\u662f\u4eba\u7c7b\u3002",
    subheading:
      "Multica 是一个代码公开（source-available）的平台，将编码 智能体 变成真正的队友。分配任务、跟踪进度、积累技能——在一个地方管理你的人类 + 智能体 团队。",
    cta: "免费开始",
  ...
  openSource: {
    ...
    headlineLine2: "\u4e3a\u6240\u6709\u4eba\u3002",
    description:
      "Multica 全部源码公开可查。审查每一行代码，按你的方式自托管，塑造人类 + 智能体 协作的未来。",
    cta: "\u5728 GitHub \u4e0a Star",
    highlights: [
      {
        title: "\u968f\u5904\u81ea\u6258\u7ba1",
    ...
    items: [
      {
        ...
        answer:
          "Multica 开箱即用支持 14 款 AI 编程工具：Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI。守护进程会自动检测本机已安装的 CLI 并为每款注册一个运行时。因为源码完全公开，你也可以自己添加后端。",
      },
      {
      ...
      },
      {
        ...
        answer:
          "取决于你的硬件。每个 智能体 有可配置的并发限制，你可以连接多台机器作为运行时。自托管版本没有任何人为限制。",
      },
    ],
  },
  ...
  footer: {
    tagline:
      "人类 + 智能体 团队的项目管理。代码公开、可自托管、为未来的工作方式而建。",
    cta: "\u5f00\u59cb\u4f7f\u7528",
    groups: {
      product: {
        label: "\u4ea7\u54c1",
  ...
  about: {
    ...
    paragraphs: [
      ...
      "这个平台的全部源码公开，并支持自托管。你的数据始终保留在自己的基础设施中。你可以审查每一行代码，扩展 API，接入自己的 LLM providers，也可以向社区贡献代码。",
    ],
    cta: "\u5728 GitHub \u4e0a\u67e5\u770b",
  },
