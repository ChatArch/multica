    ...
    entries: [
      {
        version: "0.4.13",
        date: "2026-07-28",
        title: "用量错误洞察、GitHub 仓库导入与更稳的草稿",
        changes: [],
        features: [
          "用量页面现在会显示智能体失败的频率、原因，以及哪些智能体失败最多。",
          "现在可以直接从 GitHub 里挑选仓库，不用再手填地址了。",
          "没发出的评论、回复和新 Issue，现在文字和附件都会保留到你发送。",
          "往聊天或评论里粘贴超长文本，现在会自动变成附件。",
          "子 Issue 头部现在会显示哪些智能体在工作，列表收起时也看得到。",
          "创建智能体时就能设置思考强度和 Codex 速度了。",
          "桌面端卡住时，现在能报告是哪里卡住的。",
        ],
        improvements: [
          "Autopilot 的 Webhook 链接现在默认隐藏，需要时再点开。",
          "发送之后，光标现在会停在你预期的位置。",
          "聊天里的图片和视频，多个一起来时也能稳定送达了。",
        ],
        fixes: [
          "长 Issue 上的智能体现在恢复更快、花费更少。",
          "在 Slack 和 Lark 里，智能体现在只回答结果，不再念流程。",
          "技能下载卡住时，现在会明确标出来，任务也会自动重试。",
          "删除 Issue 后现在会回到你原来的列表。",
          "本机智能体服务启动后，智能体现在会更快可用。",
        ],
      },
      {
        version: "0.4.12",
