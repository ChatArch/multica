    ...
    entries: [
      {
        version: "0.4.18",
        date: "2026-08-04",
        title: "Stopped replies pick up where they left off",
        changes: [],
        features: [
          "The assignment confirmation now finishes with your send shortcut, no mouse needed.",
          "The conversation you designed an agent in is kept, so you can read it back later.",
        ],
        improvements: [
          "Creating an agent no longer slows the rest of your workspace while the page is open.",
          "What you type while creating an agent is saved, so switching tabs never loses it.",
          "Skill files now have Edit right in the row menu.",
          "Chat suggestions now come back in the language you are writing in.",
          "Agents start each task with a shorter briefing and spend more of the run on your work.",
          "Runtimes on a local build now say so instead of offering an update that does not exist.",
          "A runtime's page no longer repeats the machine name in its title.",
        ],
        fixes: [
          "Stop a reply, send the next message, and the agent still remembers the conversation.",
          "The agent-creation box clears after you send, and text you keep typing is no longer lost.",
          "Clicking a file in a Skill opens it again instead of only showing the menu.",
          "Unsubscribe in an Issue now actually unsubscribes you.",
          "Typing / in a reply now offers your workspace's quick actions too.",
          "A blocked Issue picks its agent back up once you move it out of blocked.",
          "Opening a running agent's log from the Issue header no longer closes instantly.",
          "Mobile chat catches up on its own when a live update goes missing.",
          "OpenClaw replies now arrive as soon as they are finished, freeing the task slot.",
          "A bare /new in Slack or Feishu no longer leaves an empty message and an empty run.",
          "Newly added chat channels can receive file attachments correctly.",
          ...
          "A wide Autopilot runbook no longer pushes its settings out of the dialog.",
          "The Discord link in the Chinese sidebar is no longer cut in half.",
          "Assigning an Issue to a squad no longer fails behind the scenes.",
        ],
      },
      {
        version: "0.4.17",
